export type FallbackStandardProductCard = {
  name: string;
  description: string;
  pdfFile?: string;
};

export type FallbackBasicChemGroup = {
  name: string;
  description: string;
  items: string[];
};

export type FallbackProductsByCategory = {
  oilfieldChemicals: FallbackStandardProductCard[];
  acidStimulation: FallbackStandardProductCard[];
  fracturingFluids: FallbackStandardProductCard[];
  refineryReagents: FallbackStandardProductCard[];
...
const en = {
    oilfieldChemicals: [
      {
        ...
        description:
          'Highly effective reagents for rapid and thorough water and oil separation. Ensures stable performance at all stages of oil treatment by breaking persistent emulsions and improving dehydration.',
        pdfFile: 'Demulsifier (ICD).pdf',
      },
      {
        name: 'Wax Inhibitor (IC Wax)',
        description:
          'Reliable protection of equipment and pipelines from paraffin deposits. Effective at low dosages and particularly suitable for crude oil from the western regions of Kazakhstan.',
        pdfFile: 'Wax Inhibitor (IC Wax)_empty.pdf',
      },
      {
        name: 'Corrosion Inhibitor (ICC)',
        description:
          'Comprehensive protection against all types of corrosion, including acid corrosion. Enhances reliability and extends the service life of pipeline and processing systems.',
        pdfFile: 'Corrosion Inhibitor (ICC).pdf',
      },
      {
        name: 'Hydrate Formation Inhibitor (IC Git)',
        description:
          'Prevents the formation of hydrates in gas and oil pipelines. Ensures uninterrupted transportation of hydrocarbons even at low temperatures.',
        pdfFile: 'Hydrate Formation Inhibitor (IC Git).pdf',
      },
      {
        name: 'Biocide (ICB)',
        description:
          'Alternative formula based on THPS, glutaraldehyde, and QAC. Quickly suppresses bacterial activity, including SRB, ensuring sanitary safety of systems.',
        pdfFile: 'Biocide (ICB).pdf',
      },
      {
        name: 'Hydrogen Sulfide Scavenger (ICH)',
        description:
          'Effective solution for neutralizing H₂S in liquids and gas. Protects personnel, equipment, and the environment from toxic effects.',
        pdfFile: 'Hydrogen Sulfide Scavenger (ICH)_empty.pdf',
      },
      {
        name: 'Scale Inhibitor (ICS)',
        description:
          'Prevents the formation of carbonates, sulfates, and other mineral deposits. Maintains equipment cleanliness and process efficiency.',
        pdfFile: 'Scale Inhibitor (ICS).pdf',
      },
      {
        name: 'Flocculant (ICF)',
        description:
          'Optimizes the settling of mechanical impurities in formation water. Improves filtration and purification performance.',
        pdfFile: 'Flocculant (ICF).pdf',
      },
      {
        name: 'Drag Reducing Agent (IC DRA)',
        description:
          'Reduces hydraulic resistance and increases pipeline throughput. We also offer pumping equipment and technical support.',
      ...
      },
      {
        ...
        description:
          'Lowers pour point and viscosity of crude oil. Ensures stable pumping even in harsh climatic conditions.',
        pdfFile: 'Pour Point Depressant (IC Depr)_empty.pdf',
      },
      {
        name: 'Oxygen Scavenger (ICO)',
        description:
          'Removes dissolved oxygen from water and process fluids, preventing oxidation and corrosion of equipment.',
        pdfFile: 'Oxygen Scavenger (ICO).pdf',
      },
      {
        name: 'Coagulant (IC Coagulant)',
        description:
          'Ensures effective clarification and treatment of production water at oil fields. Ideal for preparing water for reuse.',
    ...
    acidStimulation: [
      ...
      },
      {
        ...
        description:
          'Maintains iron ions in dissolved form, preventing contamination of oil and water with iron sediments and blocking of pore throats.',
        pdfFile: 'Iron Stabilizer (IronFix).pdf',
      },
      {
        name: 'Demulsifier (SurfPro)',
        description:
          'Prevents formation of stable emulsions during interaction of acid solutions with reservoir fluids in the near-wellbore zone.',
        pdfFile: 'Demulsifier (SurfPro).pdf',
      },
      {
        name: 'Anti-Sludge (Surfactant Dispersant) (SludgeX)',
        description:
          'Prevents deposition of heavy oil fractions, minimizes the risk of formation damage, and enhances acid penetration into rock matrix.',
        pdfFile: 'Anti-Sludge (Surfactant Dispersant) (SludgeX)_empty.pdf',
      },
      {
        name: 'Hydrogen Sulfide Scavenger (SulfurX)',
        description:
          'Neutralizes H₂S, forming safe compounds and creating a protective film on metal surfaces; prevents corrosion and improves safety during acid treatments.',
        pdfFile: 'Hydrogen Sulfide Scavenger (SulfurX).pdf',
      },
      {
        name: 'Chelating Agent (CA Agent)',
        description:
          'Binds and removes metal ions (Ca²⁺, Mg²⁺, Fe³⁺), preventing scale and corrosion; maintains chemical stability of treatment fluids.',
      ...
      },
      {
        ...
        description:
          'Slows acid reaction rate in high-temperature wells, reducing corrosion and maintaining optimal rock dissolution.',
        pdfFile: 'Retarded Acid (Retarded Acid)_empty.pdf',
      },
      {
        name: 'Asphaltene/Wax Solvent (IC Solvent)',
        description:
          'Selects optimal solvent for specific asphaltene/paraffin compositions, improving viscosity and flowback.',
...
const ru = {
    oilfieldChemicals: [
      {
        ...
        description:
          'Высокоэффективные реагенты для быстрого и полного разделения воды и нефти. Обеспечивают стабильную работу на всех этапах подготовки нефти, разрушая стойкие эмульсии и улучшая процесс обезвоживания.',
        pdfFile: 'Demulsifier (ICD)_empty_ru.pdf',
      },
      {
        name: 'Ингибитор парафиноотложений (IC Wax)',
        description:
          'Надежная защита оборудования и трубопроводов от парафиновых отложений. Эффективен при низких дозировках, особенно для нефти западных регионов Казахстана.',
        pdfFile: 'Wax Inhibitor (IC Wax)_empty_ru.pdf',
      },
      {
        name: 'Ингибитор коррозии (ICC)',
        description:
          'Комплексная защита от всех видов коррозии, включая кислотную. Повышает надежность и продлевает срок службы трубопроводов и технологических систем.',
        pdfFile: 'Corrosion Inhibitor (ICC)_empty_ru.pdf',
      },
      {
        name: 'Ингибитор гидратообразования (IC Git)',
        description:
          'Предотвращает образование гидратов в газо- и нефтепроводах. Обеспечивает бесперебойную транспортировку углеводородов даже при низких температурах.',
        pdfFile: 'Hydrate Formation Inhibitor (IC Git)_empty_ru.pdf',
      },
      {
        name: 'Биоцид (ICB)',
        description:
          'Альтернативная формула на основе THPS, глутарового альдегида и ЧАС. Быстро подавляет бактериальную активность, включая сульфатвосстанавливающие бактерии, обеспечивая санитарную безопасность систем.',
        pdfFile: 'Biocide (ICB)_empty_ru.pdf',
      },
      {
        name: 'Поглотитель сероводорода (ICH)',
        description:
          'Эффективное решение для нейтрализации H₂S в жидкостях и газах. Защищает персонал, оборудование и окружающую среду от токсичного воздействия.',
        pdfFile: 'Hydrogen Sulfide Scavenger (ICH)_empty_ru.pdf',
      },
      {
        name: 'Ингибитор отложений (ICS)',
        description:
          'Предотвращает образование карбонатных, сульфатных и других минеральных отложений. Сохраняет чистоту оборудования и эффективность процессов.',
      ...
      },
      {
        ...
        description:
          'Снижает гидравлическое сопротивление и увеличивает пропускную способность трубопроводов. Также предлагаем насосное оборудование и техническую поддержку.',
      ...
      },
      {
        ...
        description:
          'Понижает температуру застывания и вязкость нефти. Обеспечивает стабильную прокачку даже в суровых климатических условиях.',
        pdfFile: 'Pour Point Depressant (IC Depr)_empty_ru.pdf',
      },
      {
        name: 'Поглотитель кислорода (ICO)',
        description:
          'Удаляет растворённый кислород из воды и технологических жидкостей, предотвращая окисление и коррозию оборудования.',
        pdfFile: 'Oxygen Scavenger (ICO)_empty_ru.pdf',
      },
      {
        name: 'Коагулянт (IC Coagulant)',
        description:
          'Обеспечивает эффективное осветление и очистку производственной воды на месторождениях. Идеален для подготовки воды к повторному использованию.',
    ...
    acidStimulation: [
      ...
      },
      {
        ...
        description:
          'Удерживает ионы железа в растворённой форме, предотвращая загрязнение нефти и воды железистыми отложениями и закупорку пор.',
        pdfFile: 'Iron Stabilizer (IronFix)_empty_ru.pdf',
      },
      {
        name: 'Деэмульгатор (SurfPro)',
        description:
          'Предотвращает образование стойких эмульсий при взаимодействии кислотных растворов с пластовыми флюидами в призабойной зоне.',
        pdfFile: 'Demulsifier (SurfPro)_empty_ru.pdf',
      },
      {
        name: 'Анти-шлам (ПАВ-диспергатор) (SludgeX)',
        description:
          'Предотвращает осаждение тяжёлых нефтяных фракций, минимизирует риск повреждения пласта и улучшает проникновение кислоты в породу.',
        pdfFile: 'Anti-Sludge (Surfactant Dispersant) (SludgeX)_empty_ru.pdf',
      },
      {
        name: 'Поглотитель сероводорода (SulfurX)',
        description:
          'Нейтрализует H₂S, образуя безопасные соединения и создаёт защитную плёнку на металлических поверхностях; предотвращает коррозию и повышает безопасность при кислотных обработках.',
        pdfFile: 'Hydrogen Sulfide Scavenger (SulfurX)_empty_ru.pdf',
      },
      {
        name: 'Хелатирующий агент (CA Agent)',
        description:
          'Связывает и удаляет ионы металлов (Ca²⁺, Mg²⁺, Fe³⁺), предотвращая образование отложений и коррозию; поддерживает химическую стабильность растворов.',
        pdfFile: 'Chelating Agent (CA Agent)_empty_ru.pdf',
      },
      {
        name: 'Химический дивертер (IC-VES)',
        description:
          'Дивертер на основе вискоэластичных ПАВ, эффективно контролирует потерю кислоты в высокопроницаемых пропластках.',
        pdfFile: 'Chemical Diverter (IC-VES)_empty_ru.pdf',
      },
      {
        name: 'Замедленная кислота (Retarded Acid)',
        description:
          'Замедляет скорость реакции кислоты в высокотемпературных скважинах, снижает коррозию и обеспечивает оптимальное растворение породы.',
        pdfFile: 'Retarded Acid (Retarded Acid)_empty_ru.pdf',
      },
      {
        name: 'Растворитель асфальтенов/парафинов (IC Solvent)',
        description:
          'Оптимальный подбор растворителя под конкретный состав асфальтенов/парафинов, улучшает вязкость и обратный приток.',
    ...
    basicChemicals: [
      {
        ...
        items: ['Моноэтиленгликоль (МЭГ)', 'Диэтиленгликоль (ДЭГ)', 'Триэтиленгликоль (ТЭГ)', 'Полиэтиленгликоль (ПЭГ)'],
      },
      {
        name: 'Амины',
        description: 'Различные амины для очистки газа и нейтрализации кислот.',
        items: ['Моноэтаноламин (МЭА)', 'Диэтаноламин (ДЭА)', 'Триэтаноламин (ТЭА)'],
      },
      {
        name: 'Кислоты',
        description: 'Высококачественные кислоты для различных промышленных применений.',
        items: ['Лимонная кислота', 'Соляная кислота (до 15%)', 'Плавиковая кислота (HF)', 'Муравьиная кислота', 'Уксусная кислота'],
      },
      {
